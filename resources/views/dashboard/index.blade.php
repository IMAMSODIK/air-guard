                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div id="location-modal" style="display: none;">
                                        <div class="modal-content">
                                            ...
                                            <p>Izinkan akses lokasi untuk menampilkan kualitas udara di daerah Anda secara
                                                otomatis.</p>
                                            <p><small>Lokasi Anda tidak akan disimpan atau dibagikan ke pihak lain.</small>
                                            </p>
                ...
                fetch(`https://api.waqi.info/search/?token=${apiToken}&keyword=${encodeURIComponent(query)}`)
                    ...
                    .then(data => {
                        ...
                        if (data.data.length === 0) {
                            resultsContainer.innerHTML =
                                '<div class="search-result-item">Tidak ada hasil ditemukan</div>';
                        } else {
                            data.data.forEach(station => {
                                ...
                                item.addEventListener('click', () => {
                                    document.getElementById('citySearch').value = station
                                        .station.name;
    ...
    `;
            ...
            if (fromAPI) {
                document.getElementById("forecast-note").textContent =
                    "Data perkiraan tidak tersedia, menggunakan estimasi berbasis data saat ini";
            } else {
                document.getElementById("forecast-note").textContent =
                    "Data perkiraan menggunakan estimasi berbasis data saat ini";
            }

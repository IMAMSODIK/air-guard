            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Air Quality News</h4>
                        <p class="">Latest updates on air pollution, environmental research, and climate change
                            impacts on air quality worldwide</p>
                    </div>
                    <div class="controls">
                        <div class="search-section" style="display: none">
                            <div class="search-box">
                                ...
                                <input type="text" id="searchInput"
                                    placeholder="Search for air quality news, pollution, PM2.5, climate...">
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal-image" id="modalImage">
                    <div
                        style="background: linear-gradient(135deg, #667eea, #764ba2); height: 300px; display: flex; align-items: center; justify-content: center; color: white; font-size: 3em;">
...
@section('own_script')
    <script>
        ...
        async function loadNews(searchQuery = 'air quality pollution PM2.5 AQI climate change environment') {
            ...
            try {
                const url =
                    `${NEWS_API_URL}?q=${encodeURIComponent(searchQuery)}&language=en&sortBy=publishedAt&pageSize=20&apiKey=${NEWS_API_KEY}`;
        ...
        function filterNews() {
            ...
            const filteredNews = currentNews.filter(article => {
                ...
                switch (currentFilter) {
                    case 'pollution':
                        return text.includes('pollution') || text.includes('pollutant') || text.includes(
                            'emission') || text.includes('smog');
                    case 'health':
                        return text.includes('health') || text.includes('medical') || text.includes('disease') ||
                            text.includes('lung') || text.includes('respiratory');
                    case 'climate':
                        return text.includes('climate') || text.includes('global warming') || text.includes(
                            'environment') || text.includes('carbon');
                    case 'research':
                        return text.includes('research') || text.includes('study') || text.includes('scientist') ||
                            text.includes('university');
                    case 'technology':
                        return text.includes('technology') || text.includes('innovation') || text.includes(
                            'sensor') || text.includes('monitoring');
                    default:
                        return true;
                }
            });
        ...
        function openNewsDetail(articleUrl) {
            ...
            if (article.urlToImage) {
                modalImage.innerHTML =
                    `<img src="${article.urlToImage}" alt="${article.title}" style="width: 100%; max-height: 400px; object-fit: cover;">`;
            } else {
                modalImage.innerHTML = `
            ...
            document.getElementById('modalReadTime').textContent =
                `Estimated reading time: ${estimateReadTime(article.content)} min`;
